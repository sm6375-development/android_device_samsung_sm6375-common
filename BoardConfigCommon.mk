...
# Kernel flags
BOARD_KERNEL_CMDLINE += console=null video=vfb:640x400 bpp=32 memsize=3072000 msm_rtb.filter=0x237 iptable_raw.raw_before_defrag=1 ip6table_raw.raw_before_defrag=1 firmware_class.path=/vendor/firmware_mnt/image bootconfig androidboot.hardware=qcom androidboot.memcg=1 androidboot.usbcontroller=4e00000.dwc3 androidboot.load_modules_parallel=true loop.max_part=7
...
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_dlkm system_ext product odm vendor vendor_dlkm
...
DEVICE_MANIFEST_blair_FILES += $(COMMON_PATH)/configs/manifest_blair.xml
